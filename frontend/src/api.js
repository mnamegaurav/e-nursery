...
export const MY_ORDER_CREATE_API = `${process.env.REACT_APP_BACKEND_API}/me/order/create/`;
...
export const MY_PLANT_CREATE_API = `${process.env.REACT_APP_BACKEND_API}/plants/create/`;
export const MY_PLANT_API = `${process.env.REACT_APP_BACKEND_API}/plant/`;
